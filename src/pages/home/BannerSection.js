        ...
        <div className="row">
            <aside className="col-md-6">
                <div className="card card-banner-lg bg-dark">
                    <img src={require("../../assets/images/banners/banner4.jpg")} className="card-img opacity" alt="" />
            ...
            <div className="col-md-6">
                <div className="card card-banner-lg bg-dark">
                    <img src={require("../../assets/images/banners/banner5.jpg")} className="card-img opacity" alt="" />
                    <div className="card-img-overlay text-white">
